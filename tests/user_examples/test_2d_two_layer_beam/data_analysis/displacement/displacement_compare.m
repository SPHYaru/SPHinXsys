...
LegendFontSize = 10;
 flag_p_pdf=0;
string_path_root='D:\SPHinXsys\CompositeMaterial5\Source\tests\user_examples\test_2d_two_layer_beam\data_analysis\'; 
stringpre=[string_path_root,'displacement_compare'];
data1=load('D:\SPHinXsys\CompositeMaterial5\Source\tests\user_examples\test_2d_two_layer_beam\data_analysis\Ana_num_material_2.txt');
data2=load('D:\SPHinXsys\CompositeMaterial5\Source\tests\user_examples\test_2d_two_layer_beam\data_analysis\numerical-20.txt');
data3=load('D:\SPHinXsys\CompositeMaterial5\Source\tests\user_examples\test_2d_two_layer_beam\data_analysis\Abbas.txt');
