...
LegendFontSize = 10;
 flag_p_pdf=0;
string_path_root='D:\SPHinXsys\CompositeMaterial5\Source\tests\user_examples\test_2d_two_layer_beam\data_analysis\displacement\'; 
stringpre=[string_path_root,'two-displacement-convergence'];
data1=load('D:\SPHinXsys\CompositeMaterial5\Source\tests\user_examples\test_2d_two_layer_beam\data_analysis\displacement\numerical-20.txt');
data2=load('D:\SPHinXsys\CompositeMaterial5\Source\tests\user_examples\test_2d_two_layer_beam\data_analysis\displacement\numerical-30.txt');
data3=load('D:\SPHinXsys\CompositeMaterial5\Source\tests\user_examples\test_2d_two_layer_beam\data_analysis\displacement\numerical-40.txt');
data4=load('D:\SPHinXsys\CompositeMaterial5\Source\tests\user_examples\test_2d_two_layer_beam\data_analysis\displacement\Ana_num_material_2.txt');
