...
int main(int ac, char *av[])
{
   ...
   //	New add
  //----------------------------------------------------------------------
    SimpleDynamics<solid_dynamics::FluidVelocityAroundSolid> fluid_velocity_around_solid(fish_contact, 4.0);
    SimpleDynamics<solid_dynamics::SolidTorque> solid_angular(fish_body, 4.0, 0.01);
    //----------------------------------------------------------------------
