...
LegendFontSize = 10;
 flag_p_pdf=0;
string_path_root='D:\SPHinXsys\CompositeMaterial5\Source\tests\user_examples\test_2d_sandwich_plate\data_analysis\energy\'; 
stringpre=[string_path_root,'sandwich-energy'];
...
data2=load('D:\SPHinXsys\CompositeMaterial5\Source\tests\user_examples\test_2d_sandwich_plate\data_analysis\energy\BeamBody_ElasticEnergy.dat');
data3=load('D:\SPHinXsys\CompositeMaterial5\Source\tests\user_examples\test_2d_sandwich_plate\data_analysis\energy\BeamBody_SolidKinecticEnergy.dat');
...
set(h1,'FontSize',11,'Fontname','Times new roman','position', [0.4,0.7,0.3,0.1])
